...
//some of this is also a type of documentation of DB values like LocationType() or DeviceType(), ect
	...
	function BuildDeviceModelArrays()
	{
		...
		$deviceModels[] = new DeviceModel("Cisco Catalyst WS-C2960-48TC-L"			, 1,48,false, true,false, true,16, 1,false);
		$deviceModels[] = new DeviceModel("Cisco Catalyst WS-C2960G-24TC-L"			, 1,24,false, true,false, true,12, 1,false);
		$deviceModels[] = new DeviceModel("Cisco Catalyst WS-C6509"					, 1, 0,false,false,false,false, 0, 6,false);
		...
		$deviceModels[] = new DeviceModel("Juniper EX3200-24T"						, 0,24,false, true,false, true,12, 1, true);
		$deviceModels[] = new DeviceModel("Juniper EX3200-48P"						, 0,48,false, true,false, true,12, 1, true);
		$deviceModels[] = new DeviceModel("Juniper Ex3200-48T"						, 0,48,false, true,false, true,12, 1, true);
		$deviceModels[] = new DeviceModel("Juniper EX3300-24P"						, 0,24,false, true,false, true,12, 1, true);
		$deviceModels[] = new DeviceModel("Juniper EX3300-24T"						, 0,24,false, true,false, true,12, 1, true);
		$deviceModels[] = new DeviceModel("Juniper EX3300-48T"						, 0,48,false, true,false, true,12, 1, true);
		$deviceModels[] = new DeviceModel("Juniper EX3400-48T-AFI"					, 0,48,false, true,false, true,12, 1, true);
		...
		$deviceModels[] = new DeviceModel("Juniper EX4300-24T"						, 0,24,false, true,false, true,12, 1, true);
		$deviceModels[] = new DeviceModel("Juniper EX4300-48T"						, 0,48,false, true,false, true,12, 1, true);
		...
		$deviceModels[] = new DeviceModel("Juniper SSG-6027R"						, 0, 7,false, true,false,false, 7, 1,false);
