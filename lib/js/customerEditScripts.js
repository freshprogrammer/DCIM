...
function EditDevice_RoomSelectChanged()
{
	...
	var page = "lib/ajax_roomSelect.php";
	var data = 'roomid='+document.getElementById("EditDevice_room").value +
	'&selectedlocationid='+selectedLocationID;
	AJAXCall(page,data,locationSelect);
}
...
{//todo - remove form action and instance id
	...
	var page = "lib/ajax_qa.php";
	var data = 'table='+table +
	'&id='+key;
	AJAXCall(page,data,cellID);
}
