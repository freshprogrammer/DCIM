...
function SaveCircuit()
{
	...
	if(add && valid)
	{
		var cancel = window.confirm("Are you sure you want to create this Circuit?") == false;
		valid = !cancel;
	}
...
{
	var confirmed;
	confirmed = window.confirm("Are you sure you want to delete this circuit and unlink it from this location?");
