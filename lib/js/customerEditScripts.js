...
function SaveLocation()
{
	...
	if(document.getElementById("EditLocation_name").value.length < 3 || document.getElementById("EditLocation_name").value.length > 50){ 
...
function DeleteLocation()
{
	...
	if(confirmed)
	{
		document.getElementById("EditLocation_action").value = "Locatione_Delete";
		document.getElementById("EditLocationForm").submit();
	}
}
