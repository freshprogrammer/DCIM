...
//END PAGE - Begin local Functions
	...
	function ValidImportDeviceModel(&$model)
	{
		...
		if($model=="")$model="";//really just here to keep the formating of the rest of the lines
		else if($model=="Poweredge R710")$model="Dell PowerEdge R710";
		else if($model=="PowerEdge R410")$model="Dell PowerEdge R410";
		else if($model=="SRX300")$model="Juniper SRX300";
		else if($model=="EX4200-48T")$model="Juniper EX4200-48T";
		else if($model=="1950 Gen 3")$model="Dell PowerEdge 1950 Gen 3";
		else if($model=="SSG-5-SH")$model="Juniper SSG-5-SH";
		else if($model=="Juniper Networks Secure Services Gateway SSG 5 - security appliance")$model="Juniper SSG-5-SH";
		else if($model=="SC811T-260")$model="SuperMicro SC811T-260";
		else if($model=="R820")$model="Dell PowerEdge R820";
		else if($model=="SRX100H2")$model="Juniper SRX100H2";
		else if($model=="6026T-NTR+")$model="SuperMicro SuperServe 6026T-NTR+";
		else if($model=="R720")$model="Dell PowerEdge R720";
		else if($model=="2950 Gen 3")$model="Dell PowerEdge 2950 Gen 3";
		else if($model=="1950 Gen 2")$model="Dell PowerEdge 1950 Gen 2";
		else if($model=="EX3200-24T")$model="Juniper EX3200-24T";
		else if($model=="SSG 140 System  512MB")$model="SSG 140 System  512MB";
		else if($model=="PowerEdge R610")$model="Dell PowerEdge R610";
		else if($model=="CSE-811TQ-520")$model="SuperMicro SuperChasis CSE-811TQ-520";
		else if($model=="EX3300-48T")$model="Juniper EX3300-48T";
		else if($model=="SRX220H2")$model="Juniper SRX220H2";
		else if($model=="SRX340")$model="Juniper SRX340";
		else if($model=="PowerEdge R730")$model="Dell PowerEdge R730";
		else if($model=="Power Edge R510")$model="Dell PowerEdge R510";
		else if($model=="2950 Gen 2")$model="Dell PowerEdge 2950 Gen 2";
		else if($model=="SSG-5-SB 128mb")$model="Juniper SSG-5-SB 128mb";
		else if($model=="SRX345")$model="Juniper SRX345";
		else if($model=="PowerEdge R630")$model="Dell PowerEdge R630";
		else if($model=="Ex3200-48T")$model="Juniper Ex3200-48T";
		else if($model=="DS-300B-8G")$model="EMC Connectrix DS-300B-8G";
		else if($model=="SSG-6027R")$model="Juniper SSG-6027R";
		else if($model=="SRX220H")$model="Juniper SRX220H";
		else if($model=="WS-C2960-48TC-L")$model="Cisco Catalyst WS-C2960-48TC-L";
		else if($model=="ProCurve 2650")$model="HP ProCurve 2650";
		else if($model=="6015V-T")$model="SuperMicro SuperServe 6015V-T";
		else if($model=="R420")$model="Dell PowerEdge R420";
		else if($model=="SRX100H")$model="Juniper SRX100H";
		else if($model=="BIG-IP SWCH LTM 2000S 8GB")$model="F5 BIG-IP SWCH LTM 2000S 8GB";
		else if($model=="SRX240H2")$model="Juniper SRX240H2";
		else if($model=="SSG-350M-SH")$model="Juniper SSG-350M-SH";
		else if($model=="1950 Gen 1")$model="Dell PowerEdge 1950 Gen 1";
		else if($model=="Log Manager Device")$model="Science Logic Log Manager Device";
		else if($model=="PowerEdge R810")$model="Dell PowerEdge R810";
		else if($model=="6013P-8 Dual 32BIT Xeon 12GB DualU320")$model="SuperMicro SuperServe 6013P-8";
		else if($model=="5015M-MT+")$model="SuperMicro SuperServe 5015M-MT+";
		else if($model=="E350GX")$model="Coyote Point E350GX";
		else if($model=="CSE-825TQ-R720LPB")$model="SuperMicro SuperChasis CSE-825TQ-R720LPB";
		else if($model=="SYS-6025W-NTR+")$model="SuperMicro SuperServe 6025W-NTR+";
		else if($model=="6025W-NTR+")$model="SuperMicro SuperServe 6025W-NTR+";
		else if($model=="2950 Gen 1")$model="Dell PowerEdge 2950 Gen 1";
		else if($model=="EX3300-24T")$model="Juniper EX3300-24T";
		else if($model=="PowerEdge 1850 Dual Xeon 3.0 2GB DDR2 (2X1GB) 73GB Raid")$model="Dell PowerEdge 1850";
		else if($model=="Ex4200-24T")$model="Juniper Ex4200-24T";
		else if($model=="BIG-IP SWCH LTM 1600 4G")$model="F5 BIG-LTM-1600-4G-R";
		else if($model=="Supermicro 4U 45 Drive JBOD Chassis")$model="SuperMicro SuperServer 4U";
		else if($model=="5015M-MT Single Pentium4 D 8GB 4xSATA")$model="SuperMicro SuperServe 5015M-MT";
		else if($model=="QFX5100-96S-AFO")$model="Juniper QFX5100-96S-AFO";
		else if($model=="SSG 140 System  256MB  ")$model="Juniper SSG-140";
		else if($model=="Procurve 2848")$model="HP Procurve 2848";
		else if($model=="EX6210-S64-96T-A25")$model="Juniper EX6210-S64-96T-A25";
		else if($model=="PowerEdge R430")$model="Dell PowerEdge R430";
		else if($model=="SRX650-BASE-SRE6-645AP")$model="Juniper SRX650-BASE-SRE6-645AP";
		else if($model=="DS-5300B-8G")$model="EMC Connectrix DS-5300B-8G";
		else if($model=="CSE-836E-16-R1200B")$model="SuperMicro SuperChasis CSE-836E-16-R1200B";
		else if($model=="FAS2554A- 001-R6")$model="Netapp FAS2554A- 001-R6";
		else if($model=="SRX345-SYS-JB")$model="Juniper SRX345-SYS-JB";
		else if($model=="SRX300-SYS-JB")$model="Juniper SRX300-SYS-JB";
		else if($model=="DS-5100B-8G ")$model="EMC Connectrix DS-5100B-8G";
		else if($model=="SRX550-645AP")$model="Juniper SRX550-645AP";
		else if($model=="PowerEdge R830")$model="Dell PowerEdge R830";
		else if($model=="6014V-T2")$model="SuperMicro SuperServe 6014V-T2";
		else if($model=="PowerEdge 1850 Dual Xeon 3.2 4GB DDR2 (2X2Gb) 146GB Raid")$model="Dell PowerEdge 1850";
		else if($model=="J9020A#ABA (2510-48)")$model="HP ProCurve 2810-48G";
		else if($model=="SYS-6026TT-BTRF")$model="SuperMicro SuperServer SYS-6026TT-BTRF";
		else if($model=="Procurve 2824")$model="HP Procurve 2824";
		else if($model=="6012")$model="SuperMicro SuperServe 6012";
		else if($model=="6013A-T Dual 32BIT Xeon 8GB 2xSATA ICH5R (RAID)")$model="SuperMicro SuperServe 6013A-T";
		else if($model=="F5-BIG-LTM-3900-8G")$model="F5 BIG-LTM-3900-8G";
		else if($model=="QFX5100-96S-AFI")$model="Juniper QFX5100-96S-AFI";
		else if($model=="VNX5700SPEF")$model="EMC VNX VNX5700SPEF";
		else if($model=="CSE-847E26-RJBOD1")$model="SuperMicro SuperChasis CSE-847E26-RJBOD1";
		else if($model=="PowerVault MD1000 3U")$model="Dell PowerVault MD1000";
		else if($model=="PowerVault MD3000 4U")$model="Dell PowerVault MD3000";
		else if($model=="PROCURVE SWITCH 2510G-24 ")$model="HP ProCurve 2510G-24";
		else if($model=="WS-C2960G-24TC-L CATALYST 2960 24PORT GIGABIT")$model="Cisco Catalyst WS-C2960G-24TC-L";
		else if($model=="PowerEdge 2850 Dual Xeon 3.2 8GB DDR2 (4X2gb) 2x73gb 4x300GB")$model="Dell PowerEdge 2850";
		else if($model=="E450GX")$model="Coyote Point E450GX";
		else if($model=="PowerEdge 2850 Dual Xeon 3.2 8GB DDR2 (4X2gb) 6 x 146GB")$model="Dell PowerEdge 2850";
		else if($model=="EX4200-24F")$model="Juniper EX4200-24F";
		else if($model=="WS-C6509")$model="Cisco Catalyst WS-C6509";
		else if($model=="MX480BASE-AC")$model="Juniper MX480BASE-AC";
		else if($model=="MAG4610")$model="Juniper Junos Pulse MAG4610";
		else if($model=="BIG-IP-LTM-6900")$model="F5 BIG-IP-LTM-6900";
		else if($model=="MX240BASE-AC-HIGH")$model="Juniper MX240BASE-AC-HIGH";
		else if($model=="QFX5100-24Q-AFI")$model="Juniper QFX5100-24Q-AFI";
		else if($model=="EX8208-BASE-AC")$model="Juniper EX8208-BASE-AC";
		else if($model=="EX3300-24P")$model="Juniper EX3300-24P";
		else if($model=="NS-ISG 1000 Advanced System  4-10/100/1000 ports")$model="Juniper NS-ISG 1000";
		else if($model=="VNX53D153015F")$model="EMC VNX VNX53D153015F";
		else if($model=="VNX51D15605F")$model="EMC VNX VNX53D156015F";
		else if($model=="CSE-837E26-RJBOD1")$model="SuperMicro SuperChasis CSE-837E26-RJBOD1";
		else if($model=="PowerEdge 2850 Dual Xeon 3.2 4GB DDR2 (2X2gb) 6 x 300GB")$model="Dell PowerEdge 2850";
		else if($model=="PowerEdge 2850 Dual Xeon 3.2 4GB DDR2 (2X2gb) 6 x 73GB")$model="Dell PowerEdge 2850";
		else if($model=="PowerEdge 2850 Dual Xeon 3.2 8GB DDR2 (4X2gb) 2x73gb 4x146GB")$model="Dell PowerEdge 2850";
		else if($model=="2610-24")$model="HP ProCurve 2610-24";
		else if($model=="6012L-6 Dual 32BIT Xeon 8GB Dual U160 ")$model="SuperMicro SuperServe 6012L-6";
		else if($model=="MAG2600")$model="Juniper Junos Pulse MAG2600";
		else if($model=="PowerEdge R730xd")$model="Dell PowerEdge R730xd";
		else if($model=="FAS8060A- 001-R6")$model="Netapp FAS8060A- 001-R6";
		else if($model=="FAS8040A- 001-R6")$model="Netapp FAS8040A- 001-R6";
		else if($model=="FAS8080AE-001-R6")$model="Netapp FAS8080AE-001-R6";
		else if($model=="FAS9000A-101-C")$model="Netapp FAS9000A-101-C";
		else if($model=="2810-48G")$model="HP ProCurve 2810-48G";
		else if($model=="PowerEdge 1850 Dual Xeon 3.0 2GB DDR2 (4X512MB) 146GB Raid")$model="Dell PowerEdge 1850";
		else if($model=="6014H-82 Dual 64BIT Xeon 16GB (DDRII) Dual U320")$model="SuperMicro SuperServe 6014H-82";
		else if($model=="PowerEdge 1850  Dual Xeon 3.0 4GB DDR2 (4X1GB) 146GB Raid")$model="Dell PowerEdge 1850";
		else if($model=="SRX340-SYS-JB")$model="Juniper SRX340-SYS-JB";
		else if($model=="CX4-480C")$model="EMC Clariion CX4-480C";
		else if($model=="PowerEdge 1850 Dual Xeon 3.0 4GB DDR2 (4X1GB) 73GB Raid")$model="Dell PowerEdge 1850";
		else if($model=="PowerEdge 1850 Dual Xeon 3.2  2GB DDR2 (2X1GB) 73GB Raid")$model="Dell PowerEdge 1850";
		else if($model=="PowerEdge 2850 Dual Xeon 3.0 4GB DDR2 (4X1gb) 3 x 73GB Raid")$model="Dell PowerEdge 2850";
		else if($model=="PowerEdge 1850 Dual Xeon 3.0 8GB DDR2 (4X2GB) 300GB Raid")$model="Dell PowerEdge 1850";
		else if($model=="OptiPlex 9020 Small Form Factor")$model="Dell OptiPlex 9020";
		else if($model=="optiplex 780")$model="Dell Optiplex 780";
		else if($model=="EX4300-24T")$model="Juniper EX4300-24T";
		else if($model=="2900-24G")$model="HP ProCurve 2900-24G";
		else if($model=="EX4200-24P")$model="Juniper EX4200-24P";
		else if($model=="EX4300-48T")$model="Juniper EX4300-48T";
