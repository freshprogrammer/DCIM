<?php 
    ...
    function CreateReport($title,$shortResult,$longResult, $note)
    {
		...
		if($enableSwitcher)
		{
    	    echo "<div id='$reportResultLongID'>\n";
    	    echo $longResult."\n";
    	    echo "</div>\n";
		}
		
		if($enableSwitcher)
	        echo "<div id='$reportResultShortID' onclick='$reportHideFunctionName();'>\n";
        else
	        echo "<div id='$reportResultShortID'>\n";
	    echo $shortResult."\n";
	    echo "</div>\n";
		...
		if($enableSwitcher)
		{
            ...
            echo "	var $reportVisibilityVariable = true;//opposite of initial condition\n";
            echo "    function $reportHideFunctionName() {\n";
            echo "        $reportVisibilityVariable = !$reportVisibilityVariable;\n";
            echo "        if($reportVisibilityVariable)\n";
            echo "        {\n";
            echo "	        //long visible\n";
            echo "			document.getElementById('$reportToggleLink').innerHTML = 'Hide';\n";
            echo "			document.getElementById('$reportResultLongID').className = '';\n";
            echo "			document.getElementById('$reportResultShortID').className = 'hidden';\n";
            echo "        }\n";
            echo "        else\n";
            echo "        {\n";
            echo "			document.getElementById('$reportToggleLink').innerHTML = 'Details';\n";
            echo "			document.getElementById('$reportResultLongID').className = 'hidden';\n";
            echo "			document.getElementById('$reportResultShortID').className = '';\n";
            echo "        }\n";
            echo "    }\n";
            echo "    $reportHideFunctionName();\n";
            echo "</script>\n";
		}
